**Для запуска необходим git и docker**
## Скрипты
...
__Результат обработки будет лежать с папке storage с тем же именем файла и в том же формате, но с полями prediction_$номер_бина.__